...
def download_speed_test(download_results, proxy, download_test_url, download_test_timeout, sema_download, speed_list):
    """
    下载速度测试
